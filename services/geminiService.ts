...
import type { ModelOverrides, ModelRole, NormalizedSource, Skill, SourceNormalizationDiagnostics, ValidationStrictness } from "../types";
            ...
            sectors: {
              ...
              items: {
                ...
                properties: {
                  ...
                  ragEvidence: {
                    type: Type.ARRAY,
                    description: "RAG chunk ids used when proposing Socrata discovery or SODA requests",
                    items: { type: Type.STRING }
                  }
                }
              }
