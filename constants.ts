...
export const OPEN_DATA_DISCOVERY_MAX_DATASETS = 500;
export const OPEN_DATA_DISCOVERY_MAX_ITEM_FETCHES = 500;
...
export const OPEN_DATA_QUERY_CACHE_MAX_ENTRIES = 300;
...
export const OPEN_DATA_PORTAL_MAX_TEXT_DATASET_QUERIES = 8;
export const OPEN_DATA_PORTAL_MAX_GEOMETRY_DATASET_QUERIES = 6;
